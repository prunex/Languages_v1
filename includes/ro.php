<p class="text"><strong>Bine ai venit in MAMP</strong></p>
<p class="text">Daca poti vedea aceasta pagina, MAMP a fost configurata corect &amp; lansat și acum este pregătită să vă difuzeze conținutul web. Această pagină de substituent<sup><a href="#footnote-1">1</a></sup> ar trebui înlocuită sau ștersă.</p>
<p class="text">
...
<p class="text" id="footnote-1"><small><sup>1</sup> Fisier: <samp>index.php</samp></small></p>
<hr>
<p class="text">Aceasta pagina in: <?php echo $switch_language; ?></p>