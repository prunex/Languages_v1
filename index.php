...
if (isset($lang) === true && $lang !== '') {
    $browser_language = (string) strtok(strip_tags($lang), ',');
} else {
    $browser_language = "";
}

// $browser_language = (isset($_GET['language']) === true && $_GET['language'] !== '') ? $_GET['language'] : $browser_language;
if (isset($_GET['language']) === true && $_GET['language'] !== '') {
    $browser_language = $_GET['language'];
}
...
foreach ($available_languages as $available_language) {
    if ($available_language['token'] !== $language) {
        $switch_language .= '<a href="'
                . strip_tags($_SERVER['PHP_SELF'])
                . '?language='
                . $available_language['token']
                . '" lang="'
                . $available_language['token']
                . '" hreflang="' . $available_language['token']
                . '">'
...
<html lang="<?php echo $language; ?>">
    ...
    <body>       
        ...
        <?php
//        if ($language === 'de'){
//            require_once "includes/de.php";
//        } elseif ($language == 'en') {
//            require_once "includes/en.php";
//        } elseif ($language == 'es') {
//            require_once "includes/es.php";
//        } elseif ($language == 'ro') {
//            require_once "includes/ro.php";
//        }
